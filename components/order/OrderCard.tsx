...
export default function OrderCard({ order }:OrderCardProps) {
    ...
    return (
        ...
        >
            ...
            <p className='text-lg font-medium text-gray-900'>Products Ordered:</p>
            <dl className="mt-6 space-y-4">
                ...
                {order.orderProducts.map((product) => (
                    ...
                    >
                        <dt className="flex items-center text-sm text-gray-600">    {/* Definition term */}
                            <span className="font-black">({product.quantity})</span>
                        </dt>
                        <dd className="text-sm font-medium text-gray-900">    {/* Definition data */}
            ...
            <form action={completeOrder}>
                ...
                <input
                    type="submit"
                    className="bg-indigo-600 hover:bg-indigo-800 transition rounded-md text-white w-full mt-5 p-3 uppercase font-bold cursor-pointer"
